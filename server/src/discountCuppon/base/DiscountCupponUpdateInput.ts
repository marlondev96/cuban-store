...
@InputType()
class DiscountCupponUpdateInput {
  @ApiProperty({
    required: false,
  })
  @IsDate()
  ...
  @ApiProperty({
    required: false,
    type: () => ProductUpdateManyWithoutDiscountCupponsInput,
  })
  @ValidateNested()
  @Type(() => ProductUpdateManyWithoutDiscountCupponsInput)
  @IsOptional()
  @Field(() => ProductUpdateManyWithoutDiscountCupponsInput, {
    nullable: true,
  })
...
export { DiscountCupponUpdateInput as DiscountCupponUpdateInput };
